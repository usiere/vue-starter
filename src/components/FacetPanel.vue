...
<template>
  ...
  >
    ...
    >
      <div
        v-if="!props.hideTitle || searchStore.hasActiveFilters"
        class="facet-header d-flex justify-space-between align-center mb-4"
        :class="{ 'justify-end': props.hideTitle && searchStore.hasActiveFilters }"
      >
        <h2 v-if="!props.hideTitle" class="text-h6">
          Filters
        </h2>
        <v-btn
